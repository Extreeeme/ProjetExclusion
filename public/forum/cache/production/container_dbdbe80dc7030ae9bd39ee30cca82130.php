...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000016aaa1f3000000003260e5f7(
...
class phpbbtemplatetwiglexer_0000000016aaa1f3000000003260e5f7 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder591e329720421587042628 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer591e329720434233759435 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties591e3297203e7170172037 = array(
    ...
    {
        $this->initializer591e329720434233759435 && $this->initializer591e329720434233759435->__invoke($this->valueHolder591e329720421587042628, $this, 'set_environment', array('env' => $env), $this->initializer591e329720434233759435);

        return $this->valueHolder591e329720421587042628->set_environment($env);
    }
    ...
    {
        $this->initializer591e329720434233759435 && $this->initializer591e329720434233759435->__invoke($this->valueHolder591e329720421587042628, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer591e329720434233759435);

        return $this->valueHolder591e329720421587042628->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer591e329720434233759435 && $this->initializer591e329720434233759435->__invoke($this->valueHolder591e329720421587042628, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer591e329720434233759435);

        return $this->valueHolder591e329720421587042628->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer591e329720434233759435 = $initializer;
    }
    ...
    {
        $this->initializer591e329720434233759435 && $this->initializer591e329720434233759435->__invoke($this->valueHolder591e329720421587042628, $this, '__get', array('name' => $name), $this->initializer591e329720434233759435);

        if (isset(self::$publicProperties591e3297203e7170172037[$name])) {
            return $this->valueHolder591e329720421587042628->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder591e329720421587042628;
    ...
    {
        $this->initializer591e329720434233759435 && $this->initializer591e329720434233759435->__invoke($this->valueHolder591e329720421587042628, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer591e329720434233759435);
    ...
    {
        $this->initializer591e329720434233759435 && $this->initializer591e329720434233759435->__invoke($this->valueHolder591e329720421587042628, $this, '__isset', array('name' => $name), $this->initializer591e329720434233759435);
    ...
    {
        $this->initializer591e329720434233759435 && $this->initializer591e329720434233759435->__invoke($this->valueHolder591e329720421587042628, $this, '__unset', array('name' => $name), $this->initializer591e329720434233759435);
    ...
    {
        $this->initializer591e329720434233759435 && $this->initializer591e329720434233759435->__invoke($this->valueHolder591e329720421587042628, $this, '__clone', array(), $this->initializer591e329720434233759435);

        $this->valueHolder591e329720421587042628 = clone $this->valueHolder591e329720421587042628;
    }

    public function __sleep()
    {
        $this->initializer591e329720434233759435 && $this->initializer591e329720434233759435->__invoke($this->valueHolder591e329720421587042628, $this, '__sleep', array(), $this->initializer591e329720434233759435);

        return array('valueHolder591e329720421587042628');
    }
    ...
    {
        return $this->initializer591e329720434233759435;
    }
    ...
    {
        return $this->initializer591e329720434233759435 && $this->initializer591e329720434233759435->__invoke($this->valueHolder591e329720421587042628, $this, 'initializeProxy', array(), $this->initializer591e329720434233759435);
    }
    ...
    {
        return null !== $this->valueHolder591e329720421587042628;
    }
    ...
    {
        return $this->valueHolder591e329720421587042628;
    }
