...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'galandas.advlogin.listener' => 'getGalandas_Advlogin_ListenerService',
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'homobb_oauth_tokens', 'homobb_oauth_states', 'homobb_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'homobb_users', $this, $this->get('dispatcher'), './', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'homobb_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'homobb_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './', 'php', 'homobb_forums', 'homobb_posts', 'homobb_topics', 'homobb_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('homobb_captcha_questions', 'homobb_captcha_answers', 'homobb_qa_confirm');
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('galandas.advlogin.listener', 'galandas\\advlogin\\event\\listener');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'homobb_ext', './', 'php', $this->get('cache'));
    }
    ...
    /**
     * Gets the 'galandas.advlogin.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \galandas\advlogin\event\listener A galandas\advlogin\event\listener instance
     */
    protected function getGalandas_Advlogin_ListenerService()
    {
        return $this->services['galandas.advlogin.listener'] = new \galandas\advlogin\event\listener($this->get('cache.driver'), $this->get('auth'), $this->get('config'), $this->get('config_text'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('dbal.conn'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './', 'adm/', 'php', 'homobb_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'homobb_migrations', './', 'php', 'homobb_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './', 'php', 'homobb_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'homobb_modules', './', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'homobb_notification_types', 'homobb_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'homobb_notification_types', 'homobb_user_notifications');
    }
    ...
    /**
     * Gets the 'paul999.mention.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \paul999\mention\controller\main A paul999\mention\controller\main instance
     */
    protected function getPaul999_Mention_ControllerService()
    {
        return $this->services['paul999.mention.controller'] = new \paul999\mention\controller\main($this->get('user'), $this->get('dbal.conn'), $this->get('auth'), $this->get('request'));
    }

    /**
     * Gets the 'paul999.mention.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \paul999\mention\event\main_listener A paul999\mention\event\main_listener instance
     */
    ...
    /**
     * Gets the 'paul999.mention.notification.type.mention' service.
     *
     * @return \paul999\mention\notification\type\mention A paul999\mention\notification\type\mention instance
     */
    protected function getPaul999_Mention_Notification_Type_MentionService()
    {
        $instance = new \paul999\mention\notification\type\mention($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'homobb_user_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'homobb_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'homobb_profile_fields', 'homobb_profile_lang', 'homobb_profile_fields_data');
    }
    ...
    {
        return $this->services['spaceace.ajaxchat.archive.controller'] = new \spaceace\ajaxchat\controller\chat($this->get('template'), $this->get('user'), $this->get('dbal.conn'), $this->get('auth'), $this->get('request'), $this->get('controller.helper'), $this->get('config'), $this->get('ext.manager'), $this->get('path_helper'), $this, 'homobb_', './', 'php');
    }
    ...
    {
        return $this->services['spaceace.ajaxchat.chat.controller'] = new \spaceace\ajaxchat\controller\chat($this->get('template'), $this->get('user'), $this->get('dbal.conn'), $this->get('auth'), $this->get('request'), $this->get('controller.helper'), $this->get('config'), $this->get('ext.manager'), $this->get('path_helper'), $this, 'homobb_', './', 'php');
    }
    ...
    {
        $this->services['spaceace.ajaxchat.cron.task.prune_ajaxchat'] = $instance = new \spaceace\ajaxchat\cron\task\prune_ajaxchat($this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('log'), 'homobb_');
    ...
    {
        return $this->services['spaceace.ajaxchat.listener'] = new \spaceace\ajaxchat\event\listener($this->get('template'), $this->get('user'), $this->get('dbal.conn'), $this->get('auth'), $this->get('request'), $this->get('controller.helper'), $this->get('config'), $this->get('config_text'), $this->get('ext.manager'), $this->get('path_helper'), $this, 'homobb_', './', 'php', $this->get('spaceace.ajaxchat.chat.controller'));
    }
    ...
    {
        return $this->services['spaceace.ajaxchat.popup.controller'] = new \spaceace\ajaxchat\controller\chat($this->get('template'), $this->get('user'), $this->get('dbal.conn'), $this->get('auth'), $this->get('request'), $this->get('controller.helper'), $this->get('config'), $this->get('ext.manager'), $this->get('path_helper'), $this, 'homobb_', './', 'php');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000005060c8760000000076bcf18e(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'homobb_bbcodes', 'homobb_smilies', 'homobb_styles', 'homobb_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'homobb_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'homobb_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'homobb_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'homobb_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'homobb_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'homobb_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'homobb_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './', 'php', 'homobb_users');
    }
    ...
    /**
     * Gets the 'vse.topicpreview.acp.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\controller\acp_controller A vse\topicpreview\controller\acp_controller instance
     */
    ...
    /**
     * Gets the 'vse.topicpreview.settings' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\core\settings A vse\topicpreview\core\settings instance
     */
    ...
    /**
     * Gets the 'vse.topicpreview.tool.bbcodes' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\core\trim\tools\bbcodes A vse\topicpreview\core\trim\tools\bbcodes instance
     */
    ...
    /**
     * Gets the 'vse.topicpreview.tool.bbcodes_legacy' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\core\trim\tools\bbcodes_legacy A vse\topicpreview\core\trim\tools\bbcodes_legacy instance
     */
    ...
    /**
     * Gets the 'vse.topicpreview.tool.markup' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\core\trim\tools\markup A vse\topicpreview\core\trim\tools\markup instance
     */
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.acl_groups' => 'homobb_acl_groups',
            'tables.acl_options' => 'homobb_acl_options',
            'tables.acl_roles' => 'homobb_acl_roles',
            'tables.acl_roles_data' => 'homobb_acl_roles_data',
            'tables.acl_users' => 'homobb_acl_users',
            'tables.attachments' => 'homobb_attachments',
            'tables.auth_provider_oauth_token_storage' => 'homobb_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'homobb_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'homobb_oauth_accounts',
            'tables.banlist' => 'homobb_banlist',
            'tables.bbcodes' => 'homobb_bbcodes',
            'tables.bookmarks' => 'homobb_bookmarks',
            'tables.bots' => 'homobb_bots',
            'tables.captcha_qa_questions' => 'homobb_captcha_questions',
            'tables.captcha_qa_answers' => 'homobb_captcha_answers',
            'tables.captcha_qa_confirm' => 'homobb_qa_confirm',
            'tables.config' => 'homobb_config',
            'tables.config_text' => 'homobb_config_text',
            'tables.confirm' => 'homobb_confirm',
            'tables.disallow' => 'homobb_disallow',
            'tables.drafts' => 'homobb_drafts',
            'tables.ext' => 'homobb_ext',
            'tables.extensions' => 'homobb_extensions',
            'tables.extension_groups' => 'homobb_extension_groups',
            'tables.forums' => 'homobb_forums',
            'tables.forums_access' => 'homobb_forums_access',
            'tables.forums_track' => 'homobb_forums_track',
            'tables.forums_watch' => 'homobb_forums_watch',
            'tables.groups' => 'homobb_groups',
            'tables.icons' => 'homobb_icons',
            'tables.lang' => 'homobb_lang',
            'tables.log' => 'homobb_log',
            'tables.login_attempts' => 'homobb_login_attempts',
            'tables.migrations' => 'homobb_migrations',
            'tables.moderator_cache' => 'homobb_moderator_cache',
            'tables.modules' => 'homobb_modules',
            'tables.notification_types' => 'homobb_notification_types',
            'tables.notifications' => 'homobb_notifications',
            'tables.poll_options' => 'homobb_poll_options',
            'tables.poll_votes' => 'homobb_poll_votes',
            'tables.posts' => 'homobb_posts',
            'tables.privmsgs' => 'homobb_privmsgs',
            'tables.privmsgs_folder' => 'homobb_privmsgs_folder',
            'tables.privmsgs_rules' => 'homobb_privmsgs_rules',
            'tables.privmsgs_to' => 'homobb_privmsgs_to',
            'tables.profile_fields' => 'homobb_profile_fields',
            'tables.profile_fields_data' => 'homobb_profile_fields_data',
            'tables.profile_fields_options_language' => 'homobb_profile_fields_lang',
            'tables.profile_fields_language' => 'homobb_profile_lang',
            'tables.ranks' => 'homobb_ranks',
            'tables.reports' => 'homobb_reports',
            'tables.reports_reasons' => 'homobb_reports_reasons',
            'tables.search_results' => 'homobb_search_results',
            'tables.search_wordlist' => 'homobb_search_wordlist',
            'tables.search_wordmatch' => 'homobb_search_wordmatch',
            'tables.sessions' => 'homobb_sessions',
            'tables.sessions_keys' => 'homobb_sessions_keys',
            'tables.sitelist' => 'homobb_sitelist',
            'tables.smilies' => 'homobb_smilies',
            'tables.sphinx' => 'homobb_sphinx',
            'tables.styles' => 'homobb_styles',
            'tables.styles_template' => 'homobb_styles_template',
            'tables.styles_template_data' => 'homobb_styles_template_data',
            'tables.styles_theme' => 'homobb_styles_theme',
            'tables.styles_imageset' => 'homobb_styles_imageset',
            'tables.styles_imageset_data' => 'homobb_styles_imageset_data',
            'tables.teampage' => 'homobb_teampage',
            'tables.topics' => 'homobb_topics',
            'tables.topics_posted' => 'homobb_topics_posted',
            'tables.topics_track' => 'homobb_topics_track',
            'tables.topics_watch' => 'homobb_topics_watch',
            'tables.user_group' => 'homobb_user_group',
            'tables.user_notifications' => 'homobb_user_notifications',
            'tables.users' => 'homobb_users',
            'tables.warnings' => 'homobb_warnings',
            'tables.words' => 'homobb_words',
            'tables.zebra' => 'homobb_zebra',
...
class phpbbtemplatetwiglexer_000000005060c8760000000076bcf18e extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder591e31679832d823817733 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer591e316798342431041730 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties591e3167982f1377654167 = array(
    ...
    {
        $this->initializer591e316798342431041730 && $this->initializer591e316798342431041730->__invoke($this->valueHolder591e31679832d823817733, $this, 'set_environment', array('env' => $env), $this->initializer591e316798342431041730);

        return $this->valueHolder591e31679832d823817733->set_environment($env);
    }
    ...
    {
        $this->initializer591e316798342431041730 && $this->initializer591e316798342431041730->__invoke($this->valueHolder591e31679832d823817733, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer591e316798342431041730);

        return $this->valueHolder591e31679832d823817733->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer591e316798342431041730 && $this->initializer591e316798342431041730->__invoke($this->valueHolder591e31679832d823817733, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer591e316798342431041730);

        return $this->valueHolder591e31679832d823817733->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer591e316798342431041730 = $initializer;
    }
    ...
    {
        $this->initializer591e316798342431041730 && $this->initializer591e316798342431041730->__invoke($this->valueHolder591e31679832d823817733, $this, '__get', array('name' => $name), $this->initializer591e316798342431041730);

        if (isset(self::$publicProperties591e3167982f1377654167[$name])) {
            return $this->valueHolder591e31679832d823817733->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder591e31679832d823817733;
    ...
    {
        $this->initializer591e316798342431041730 && $this->initializer591e316798342431041730->__invoke($this->valueHolder591e31679832d823817733, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer591e316798342431041730);
    ...
    {
        $this->initializer591e316798342431041730 && $this->initializer591e316798342431041730->__invoke($this->valueHolder591e31679832d823817733, $this, '__isset', array('name' => $name), $this->initializer591e316798342431041730);
    ...
    {
        $this->initializer591e316798342431041730 && $this->initializer591e316798342431041730->__invoke($this->valueHolder591e31679832d823817733, $this, '__unset', array('name' => $name), $this->initializer591e316798342431041730);
    ...
    {
        $this->initializer591e316798342431041730 && $this->initializer591e316798342431041730->__invoke($this->valueHolder591e31679832d823817733, $this, '__clone', array(), $this->initializer591e316798342431041730);

        $this->valueHolder591e31679832d823817733 = clone $this->valueHolder591e31679832d823817733;
    }

    public function __sleep()
    {
        $this->initializer591e316798342431041730 && $this->initializer591e316798342431041730->__invoke($this->valueHolder591e31679832d823817733, $this, '__sleep', array(), $this->initializer591e316798342431041730);

        return array('valueHolder591e31679832d823817733');
    }
    ...
    {
        return $this->initializer591e316798342431041730;
    }
    ...
    {
        return $this->initializer591e316798342431041730 && $this->initializer591e316798342431041730->__invoke($this->valueHolder591e31679832d823817733, $this, 'initializeProxy', array(), $this->initializer591e316798342431041730);
    }
    ...
    {
        return null !== $this->valueHolder591e31679832d823817733;
    }
    ...
    {
        return $this->valueHolder591e31679832d823817733;
    }
