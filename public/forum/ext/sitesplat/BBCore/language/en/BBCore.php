...
$lang = array_merge($lang, array(
  ...
  'UCP_REGISTER_EMAIL_EXPLAIN'   => 'Merci de ne pas utiliser une adresse mail de type jetable.',
  'UCP_REG_USR_PLACEHOLDER'      => 'Ex: John Doe',
  'UCP_REG_EMAIL_PLACEHOLDER'    => 'Ex: johndoe@mail.com',
  'UCP_REG_PSWD_PLACEHOLDER'     => 'Ex: ASDFasdf123',
  ...
  'MODERATOR_PANEL_GENERAL'      => 'Panel de modération',
  'ADMIN_PANEL_GENERAL'          => 'Panel d\'administration',
  ...
  'LOGIN_HIDE_ME'        		 => 'Cacher sa présence en ligne',
  ...
  'NO_PMS_INFO'	                 => 'Votre boîte de réception est vide.',
  
  'DATES'       			     => 'DATE',
  'POWERED'       			     => 'Créer avec',
  'HANDCRAFTED'       			 => 'Design fais avec',
  'BY'       					 => 'par',
  ...
  'SITESPLAT_TOTAL_POSTS'		 => 'Nombre de messages',
  'SITESPLAT_TOTAL_TOPICS'	     => 'Nombre de sujets',
  'SITESPLAT_TOTAL_USERS'		 => 'Nombre d\'utilisateurs',
  'SITESPLAT_NEWEST_MEMBER'		 => 'Dernier utilisateur',
  'SITESPLAT_USERS_ONLINE'		 => 'Utilisateurs connectés',
  'SITESPLAT_MOST_USERS_ONLINE'	 => 'Record d\'utilisateurs connectés',
  ...
  'PASSWORD_EXPLAIN_CONFIRM'	 => 'Assurez-vous que les mots de passe correspondent.',
  ...
  'READ_MORE'	                 => 'En savoir plus <i class="fa fa-hand-o-right" aria-hidden="true"></i>',
  ...
  'FLATBOOTS_INTRO'	             => 'Luttons contre l\'homophobie',
  'FLATBOOTS_EXPLAIN'	         => 'Venez nous aider et apprenons à être tolérent sur www.leguidedubonhomophobe.com',
  'CALL_TO_ACTION_FOOTER'        => 'Swap-in out addons, use only what you really need!',
  'PURCHASE_NOW_BTN'             => 'Purchase now',
  'FLATBOOTS_ABOUT_PART_ONE'     => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras dapibus felis non vulputate pretium. Quisque pulvinar et ipsum eget commodo. Quisque venenatis odio tortor, sit amet commodo mi semper in. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.',
  'FLATBOOTS_ABOUT_TITLE'	     => 'Qui sommes nous ?',
  'DMCA'	                     => 'DMCA',
